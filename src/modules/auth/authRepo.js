...
//   // Create or update minimal profile for Google-based accounts
...
//     // Patch missing profile fields for returning Google users
//     const updates = {};
...
//     if (userData.profile_picture && !user.profile_picture)
//       updates.profile_picture = userData.profile_picture;

//     if (userData.phone_country_code && !user.phone_country_code)
//       updates.phone_country_code = userData.phone_country_code;

//     if (userData.phone_number && !user.phone_number)
//       updates.phone_number = userData.phone_number;

//     // NEW: Assign timezone only if user doesn't already have one
